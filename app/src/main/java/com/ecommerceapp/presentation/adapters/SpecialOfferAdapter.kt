...
class SpecialOfferAdapter (private var list: ArrayList<ItemModel>, private val context: Context) :
    ...
    fun updateList(grideList: List<ItemModel>) {
        list.clear()
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: ItemModel) {
            ...
            itemPrice.text = item.productPrice.toDouble().toString()
