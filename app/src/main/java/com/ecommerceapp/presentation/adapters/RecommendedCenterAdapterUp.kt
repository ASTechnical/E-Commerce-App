...
class RecommendedCenterAdapterUp (private var list: ArrayList<ItemModel>, private val context: Context) :
RecyclerView.Adapter<RecommendedCenterAdapterUp.ViewHolder>() {
