...
class ChildernImageAdapter(private var imageslist: ArrayList<ImageItemModel>, private val context: Context) :
    RecyclerView.Adapter<ChildernImageAdapter.ViewHolder>() {
