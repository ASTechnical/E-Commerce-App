...
class ChildernCenterAdapterDown (private var list: ArrayList<ItemModel>, private val context: Context) :
RecyclerView.Adapter<ChildernCenterAdapterDown.ViewHolder>() {
