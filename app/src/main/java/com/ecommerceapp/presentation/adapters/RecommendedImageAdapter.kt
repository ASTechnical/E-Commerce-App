...
class RecommendedImageAdapter(private var imageslist: ArrayList<ImageItemModel>, private val context: Context) :
    RecyclerView.Adapter<RecommendedImageAdapter.ViewHolder>() {
    ...
    fun updateList(newList: List<ImageItemModel>) {
        imageslist.clear()
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val childItem: ImageView = itemView.findViewById(R.id.childItem)
