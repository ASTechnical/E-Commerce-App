...
class RecommendedCenterAdapter(private var list: ArrayList<ItemModel>, private val context: Context) :
    RecyclerView.Adapter<RecommendedCenterAdapter.ViewHolder>() {
