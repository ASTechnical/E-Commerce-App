...
public abstract class Hilt_FavouriteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavouriteFragment() {
    super();
  }

  Hilt_FavouriteFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavouriteFragment_GeneratedInjector) this.generatedComponent()).injectFavouriteFragment(UnsafeCasts.<FavouriteFragment>unsafeCast(this));
    }
  }
