...
public abstract class Hilt_CatogeryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CatogeryFragment() {
    super();
  }

  Hilt_CatogeryFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CatogeryFragment_GeneratedInjector) this.generatedComponent()).injectCatogeryFragment(UnsafeCasts.<CatogeryFragment>unsafeCast(this));
    }
  }
