...
public abstract class Hilt_OrderFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderFragment_GeneratedInjector) this.generatedComponent()).injectOrderFragment(UnsafeCasts.<OrderFragment>unsafeCast(this));
    }
  }
