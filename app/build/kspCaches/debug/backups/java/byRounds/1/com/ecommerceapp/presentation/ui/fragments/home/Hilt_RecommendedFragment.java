...
public abstract class Hilt_RecommendedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecommendedFragment() {
    super();
  }

  Hilt_RecommendedFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecommendedFragment_GeneratedInjector) this.generatedComponent()).injectRecommendedFragment(UnsafeCasts.<RecommendedFragment>unsafeCast(this));
    }
  }
