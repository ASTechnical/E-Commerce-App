...
public abstract class Hilt_ChildrenFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChildrenFragment() {
    super();
  }

  Hilt_ChildrenFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChildrenFragment_GeneratedInjector) this.generatedComponent()).injectChildrenFragment(UnsafeCasts.<ChildrenFragment>unsafeCast(this));
    }
  }
