...
public abstract class Hilt_TrendingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TrendingFragment() {
    super();
  }

  Hilt_TrendingFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TrendingFragment_GeneratedInjector) this.generatedComponent()).injectTrendingFragment(UnsafeCasts.<TrendingFragment>unsafeCast(this));
    }
  }
