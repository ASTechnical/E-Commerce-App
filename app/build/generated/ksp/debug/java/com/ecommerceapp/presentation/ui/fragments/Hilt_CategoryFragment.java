...
public abstract class Hilt_CategoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CategoryFragment() {
    super();
  }

  Hilt_CategoryFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CategoryFragment_GeneratedInjector) this.generatedComponent()).injectCategoryFragment(UnsafeCasts.<CategoryFragment>unsafeCast(this));
    }
  }
