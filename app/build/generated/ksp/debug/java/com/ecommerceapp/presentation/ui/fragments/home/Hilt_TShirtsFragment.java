...
public abstract class Hilt_TShirtsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TShirtsFragment() {
    super();
  }

  Hilt_TShirtsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TShirtsFragment_GeneratedInjector) this.generatedComponent()).injectTShirtsFragment(UnsafeCasts.<TShirtsFragment>unsafeCast(this));
    }
  }
