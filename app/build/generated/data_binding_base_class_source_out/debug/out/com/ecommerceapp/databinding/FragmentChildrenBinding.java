...
public final class FragmentChildrenBinding implements ViewBinding {
  ...
  private FragmentChildrenBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout all,
  ...
  @NonNull
  public static FragmentChildrenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentChildrenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_children, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentChildrenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentChildrenBinding((ConstraintLayout) rootView, all, childLinarLaout,
