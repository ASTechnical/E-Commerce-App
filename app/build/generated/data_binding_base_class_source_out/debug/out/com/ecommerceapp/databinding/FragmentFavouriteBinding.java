...
public final class FragmentFavouriteBinding implements ViewBinding {
  ...
  private FragmentFavouriteBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
  ...
  public static FragmentFavouriteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFavouriteBinding((ConstraintLayout) rootView, button, mainRecyclerView,
