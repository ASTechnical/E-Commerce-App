...
public final class ParentItemBinding implements ViewBinding {
  ...
  private ParentItemBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView,
  ...
  public static ParentItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ParentItemBinding((ConstraintLayout) rootView, cardView, forCardView,
