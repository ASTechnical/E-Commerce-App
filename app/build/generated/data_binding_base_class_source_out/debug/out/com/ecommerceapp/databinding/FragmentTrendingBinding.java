...
public final class FragmentTrendingBinding implements ViewBinding {
  ...
  private FragmentTrendingBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ShimmerFrameLayout grideRecyclerViewShimmerEffect, @NonNull ImageView imageView7,
      @NonNull ImageView imageView8, @NonNull RecyclerView mainRecyclerView,
      @NonNull ShimmerFrameLayout matchesShimmerLayout, @NonNull NestedScrollView nestedScrollView,
      @NonNull NoIntentLayoutBinding noInternet, @NonNull ConstraintLayout parentLinearyLayout,
      ...
      @NonNull ShimmerFrameLayout upcomingMatchesShimmerLayout) {
  ...
  public static FragmentTrendingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTrendingBinding((ConstraintLayout) rootView, FeaturedProduct, all,
          childLinarLaout, childern, circleRecyclerView, circleimg, constraintLayout,
          gride2RecyclerView, grideRecyclerView, grideRecyclerViewShimmerEffect, imageView7,
