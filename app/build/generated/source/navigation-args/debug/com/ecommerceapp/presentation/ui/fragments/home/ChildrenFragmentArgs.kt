...
public data class ChildrenFragmentArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): ChildrenFragmentArgs {
      bundle.setClassLoader(ChildrenFragmentArgs::class.java.classLoader)
      ...
      return ChildrenFragmentArgs(__itemModel)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): ChildrenFragmentArgs {
      val __itemModel : ItemModel?
