...
public data class OrderFragmentArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): OrderFragmentArgs {
      bundle.setClassLoader(OrderFragmentArgs::class.java.classLoader)
      ...
      return OrderFragmentArgs(__itemModel)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): OrderFragmentArgs {
      val __itemModel : ItemModel?
