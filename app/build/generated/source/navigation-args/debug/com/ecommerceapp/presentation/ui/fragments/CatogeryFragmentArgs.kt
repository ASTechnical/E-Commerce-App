...
public data class CatogeryFragmentArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): CatogeryFragmentArgs {
      bundle.setClassLoader(CatogeryFragmentArgs::class.java.classLoader)
      ...
      return CatogeryFragmentArgs(__itemModel)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): CatogeryFragmentArgs {
      val __itemModel : ItemModel?
