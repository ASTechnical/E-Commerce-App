...
public data class FavouriteFragmentArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): FavouriteFragmentArgs {
      bundle.setClassLoader(FavouriteFragmentArgs::class.java.classLoader)
      ...
      return FavouriteFragmentArgs(__itemModel)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): FavouriteFragmentArgs {
      val __itemModel : ItemModel?
